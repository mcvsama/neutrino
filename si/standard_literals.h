...
#ifndef NEUTRINO__SI__STANDARD_LITERALS_H__INCLUDED
#define NEUTRINO__SI__STANDARD_LITERALS_H__INCLUDED
...
SI_DEFINE_LITERAL (Nanometer, _nm)
SI_DEFINE_LITERAL (Tonne, _ton)
SI_DEFINE_LITERAL (Gram, _g)
...
SI_DEFINE_LITERAL (TeraHertz, _THz)
SI_DEFINE_LITERAL (GigaHertz, _GHz)
...
SI_DEFINE_LITERAL (MilliOhm, _mOhm)
SI_DEFINE_LITERAL (KiloOhm, _kOhm)
SI_DEFINE_LITERAL (MegaOhm, _MOhm)
SI_DEFINE_LITERAL (GigaOhm, _GOhm)
SI_DEFINE_LITERAL (NanoVolt, _nV)
SI_DEFINE_LITERAL (MicroVolt, _uV)
SI_DEFINE_LITERAL (MilliVolt, _mV)
SI_DEFINE_LITERAL (KiloVolt, _kV)
SI_DEFINE_LITERAL (MegaVolt, _MV)
SI_DEFINE_LITERAL (PicoFarad, _pF)
SI_DEFINE_LITERAL (NanoFarad, _nF)
SI_DEFINE_LITERAL (MicroFarad, _uF)
SI_DEFINE_LITERAL (MilliFarad, _mF)
